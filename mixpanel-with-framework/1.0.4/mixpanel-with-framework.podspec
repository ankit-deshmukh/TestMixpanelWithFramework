Pod::Spec.new do |s|
  ...
  s.source ={ :http => "https://gateway.smallcase.com/scgateway_mixpanel/1.0.4/MixpanelWithFrameworkDemo.xcframework.zip"}
...
#  s.user_target_xcconfig = { 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64' }
  ...
  s.ios.vendored_framework = 'MixpanelWithFrameworkDemo.xcframework'
